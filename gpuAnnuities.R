...
priceAnnuityPayments <- function(paymentProbsA, yieldData, gteeYrs = 0,
  paymentTiming = c("start", "end"),
  paymentProbsB = NULL, spousePpn = 0,
  lifeBInitialSurvivalAssumed = TRUE) {
